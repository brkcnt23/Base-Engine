...
namespace Base {
    public static class B_CentralEventSystem {
        ...
        public static bool CentralEventSystemStrapping() {
    ...
    public class B_CES_Events {
        ...
        public void AddFunction(Action actionToAdd, bool isConstantEvent = false) {
