...
#pragma warning restore CS1998
        ...
        public UI_TComponentsSubframe GetUIComponent(object frameEnum) {
            return SubComponents.FirstOrDefault(t => t.EnumName == frameEnum.ToString());
        }
